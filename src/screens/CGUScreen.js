...
'9. MISE EN RELATION MENAGE\nL\'Application facilite la mise en relation entre hotes et prestataires de menage. MyHostKit n\'est pas employeur des prestataires et n\'est pas responsable de la qualite des prestations realisees. Les prestataires exercent en tant qu\'independants et sont seuls responsables de leur activite, de leurs obligations sociales et fiscales.\n\n' +
...
'16. FACTURATION\nUne facture conforme aux obligations legales francaises (art. 289 CGI) est generee automatiquement apres chaque prestation validee. Mentions obligatoires : identite des parties, description, montant HT, commission MyHostKit, mentions TVA. Les factures sont conservees 10 ans conformement a la loi.\n\n' +
'17. MEDIATION DE LA CONSOMMATION\nConformement a l\'article L.612-1 du Code de la consommation, en cas de litige non resolu a l\'amiable, le consommateur peut recourir gratuitement au mediateur de la consommation suivant : [NOM_MEDIATEUR_A_CHOISIR]. Le mediateur peut egalement etre saisi en ligne via la plateforme europeenne de reglement en ligne des litiges : https://ec.europa.eu/consumers/odr/.\n\n' +
...
export default function CGUScreen(props) {
  ...
  function accept() {
    ...
    supabase.from('cgu_acceptances').insert({
      ...
      consent_text: 'J\'ai lu et j\'accepte les Conditions Générales d\'Utilisation de MyHostKit (version ' + CGU_VERSION + ').',
    }).then(function(r) {
      setLoading(false);
    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={s.footer}>
        ...
        <TouchableOpacity style={s.checkRow} onPress={function() { setAccepted(!accepted); }} activeOpacity={0.7}>
          ...
          <Text style={s.checkText}>J'ai lu et j'accepte les Conditions Générales d'Utilisation de MyHostKit</Text>
        </TouchableOpacity>
